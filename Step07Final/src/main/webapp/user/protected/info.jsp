...
<%
	// SessionDto 로 DB에 있는 userDto 받아오기
...
<body>
	<div class="container">
		<a href="update-form.jsp">개인 정보 수정</a>
		<h1>가입 정보입니다</h1>
		<table>
			<tr>
				<th>아이디</th>
			...
			<tr>
				...
				<td>
					<c:choose>
						...
						<c:otherwise>
							<img src="profileImage" alt="${pageContext.request.contextPath }/upload/${dto.profileImage }" alt="프로필 이미지" />
						</c:otherwise>
					</c:choose>
				</td>
			</tr>
